...
**[TDD project]** is a software development methodology that emphasizes writing tests before writing the actual code.
...
```sh
  cd TDD project
  git clone https://github.com/HERMON-1995/TDD-project.git
```
...
Feel free to check the [issues page](https://github.com/HERMON-1995/TDD-project/issues).
